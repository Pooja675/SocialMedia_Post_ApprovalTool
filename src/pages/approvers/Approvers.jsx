...
const Approvers = () => {
      ...
      cell: (row) => (
        <div className="radio-container">
          <FaCheck
            style={{
              color:
                approvalStatus[row.id] === "Ready for posting"
                  ? "green"
                  : "black",
            }}
          ...
          <MdClose
            style={{
              color:
                approvalStatus[row.id] === "design-pending" ? "red" : "black",
            }}
            // onClick={() => saveApprovalStatus(doc.id)}
            onClick={() =>
              setApprovalStatus((prevState) => ({
                ...prevState,
                [row.id]: "design-pending",
              }))
            }
          />
        </div>
    ...
    },
    {
      ...
      cell: (row) => (
        <button
          ...
          onClick={() => saveApprovalStatus(row.id)}
        >
          Submit
        </button>
      ),
  ...
  return (
    <div className="container" style={{ paddingTop: "150px" }}>
      <h2 className="mb-4 text-center">Approver</h2>
